...
public class lb_boss_battle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ranking();
        btn_boss_battle.setTextColor(Color.RED);
        tvranking.setText("Universe Ranking (boss)");
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for(DataSnapshot ds : dataSnapshot.getChildren()) {
                    boss_time = ds.child("best_boss_battle").getValue(float.class);
                    ...
                    if(boss_time !=0){
                        totalranks++;
                        hashMap.put(Uemail+":"+username +":" + Upic, boss_time);
                    }
                    if(totalranks%10==0){
