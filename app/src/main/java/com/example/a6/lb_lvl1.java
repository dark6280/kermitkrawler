...
public class lb_lvl1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ranking();
        btnlvl1.setTextColor(Color.RED);
        tvranking.setText("Universe Ranking (lvl1)");
    ...
    public void ShowRanks(){
        ...
        while(myVeryOwnIterator.hasNext()) {
            ...
            value=(sortedMapAsc.get(key)).toString();
            if(i==1+(page-1)*10){
                if(mUser!=null){
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for(DataSnapshot ds : dataSnapshot.getChildren()) {
                    lvl1 = ds.child("best_lvl1").getValue(float.class);
                    ...
                    if(lvl1 !=0){
                        totalranks++;
                        hashMap.put(Uemail+":"+username +":" + Upic, lvl1);
                    }
                    if(totalranks%10==0){
    ...
    private static Map<String, Float> sortByValue(Map<String, Float> unsortMap, final boolean order){ //true - small to big, false - big to small
    ...
    public void onClick1(View view){
        ...
        if(view==btnextreme){
            startActivity(new Intent(this, lb_bestscore.class));
        }
        if(view == btn_boss_battle){
            startActivity(new Intent(this, lb_boss_battle.class));
        }
        if(view==btnlvl2){
