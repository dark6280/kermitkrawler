...
public class lb_lvl2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ranking();
        btnlvl2.setTextColor(Color.RED);
        tvranking.setText("Universe Ranking (lvl2)");
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for(DataSnapshot ds : dataSnapshot.getChildren()) {
                    lvl2 = ds.child("best_lvl2").getValue(float.class);
                    ...
                    if(lvl2 !=0){
                        totalranks++;
                        hashMap.put(Uemail+":"+username +":" + Upic, lvl2);
                    }
                    if(totalranks%10==0){
