...
public class lb_lvl3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ranking();
        btnlvl3.setTextColor(Color.RED);
        tvranking.setText("Universe Ranking (lvl3)");
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for(DataSnapshot ds : dataSnapshot.getChildren()) {
                    lvl3 = ds.child("best_lvl3").getValue(float.class);
                    ...
                    if(lvl3 !=0){
                        totalranks++;
                        hashMap.put(Uemail+":"+username +":" + Upic, lvl3);
                    }
                    if(totalranks%10==0){
