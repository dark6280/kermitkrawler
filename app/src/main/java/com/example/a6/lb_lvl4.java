...
public class lb_lvl4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ranking();
        btnlvl4.setTextColor(Color.RED);
        tvranking.setText("Universe Ranking (lvl4)");
        ...
        ValueEventListener eventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for(DataSnapshot ds : dataSnapshot.getChildren()) {
                    lvl4 = ds.child("best_lvl4").getValue(float.class);
                    ...
                    if(lvl4 !=0){
                        totalranks++;
                        hashMap.put(Uemail+":"+username +":" + Upic, lvl4);
                    }
                    if(totalranks%10==0){
