...
import java.util.Map;
    ...
    public class lb_totalscore extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            Ranking();
            btnnormal.setTextColor(Color.RED);
            tvranking.setText("Universe Ranking (totalscore)");
            ...
            ValueEventListener eventListener = new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    for(DataSnapshot ds : dataSnapshot.getChildren()) {
                        totalscore = ds.child("totalscore").getValue(int.class);
                        ...
                        if(totalscore!=0){
                            totalranks++;
                            hashMap.put(Uemail+":"+username +":" + Upic,totalscore);
                        }
                        if(totalranks%10==0){
