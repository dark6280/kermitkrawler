...
public class level2_act extends AppCompatActivity {
    ...
    ImageView spikes1,spikes2,spikes3,spikes4;
    ...
    public void ongroundthings(){
        ...
        if(isCollisionDetected(kermit,ground)|| isCollisionDetected(kermit,platform1)|| isCollisionDetected(kermit,platform3)|| isCollisionDetected(kermit,platform4)|| isCollisionDetected(kermit,platform5)){
            onground= true;
            height =0;
            maxheight = false;
        }
    ...
    public void hitwalltoleft(){
        ...
        if(isCollisionDetected(kermit,wallleft)||isCollisionDetected(kermit,rw_platform1)|| isCollisionDetected(kermit,rw_platform3)|| isCollisionDetected(kermit,rw_platform4)|| isCollisionDetected(kermit,rw_platform5))
            hitleft= true;
        else
            hitleft= false;
    }
    ...
    public void hitwalltoright(){
        ...
        if(isCollisionDetected(kermit,wallright) || isCollisionDetected(kermit,lw_platform1)|| isCollisionDetected(kermit,lw_platform3)|| isCollisionDetected(kermit,lw_platform4)|| isCollisionDetected(kermit,lw_platform5) )
            hitright= true;
        else
            hitright= false;
    }
    ...
    public void hitwallup(){
        ...
        if(isCollisionDetected(kermit,dw_platform1)  || isCollisionDetected(kermit,dw_platform3)  || isCollisionDetected(kermit,dw_platform4) || isCollisionDetected(kermit,dw_platform5)){
            maxheight = true;
        }
    }
    ...
    public void spikesandNextLevel(){
        if(isCollisionDetected(kermit,spikes1) || isCollisionDetected(kermit,spikes2) || isCollisionDetected(kermit,spikes3)|| isCollisionDetected(kermit,spikes4)) {
            if(!dead) {
                dead = true;
                onground= true;
            }
