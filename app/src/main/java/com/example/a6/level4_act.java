...
public class level4_act extends AppCompatActivity {
    ...
    ImageView platform6,lw_platform6,rw_platform6,dw_platform6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        platform6 = findViewById(R.id.iv_platform6);
        lw_platform6 = findViewById(R.id.lw_ivplatform6);
        rw_platform6 = findViewById(R.id.rw_ivplatform6);
        dw_platform6 = findViewById(R.id.dw_ivplatform6);


        tvscore.setText("score: " + (getIntent().getExtras().getInt("score") + 1));
    ...
    public void ongroundthings(){
        ...
        if(isCollisionDetected(kermit,ground)|| isCollisionDetected(kermit,platform1)|| isCollisionDetected(kermit,platform2)|| isCollisionDetected(kermit,platform3)|| isCollisionDetected(kermit,platform4)|| isCollisionDetected(kermit,platform5)|| isCollisionDetected(kermit,platform6)){
            onground= true;
            height =0;
            maxheight = false;
        }
        ...
        if( (isCollisionDetected(kermit,platform6) && isCollisionDetected(kermit,lw_platform6)|| (isCollisionDetected(kermit,platform6) && isCollisionDetected(kermit,rw_platform6)))){
            kermit.setY((float) (kermit.getY() -1));
        }
    ...
    public void hitwalltoleft(){
        ...
        if(isCollisionDetected(kermit,wallleft)||isCollisionDetected(kermit,rw_platform1)|| isCollisionDetected(kermit,rw_platform2)|| isCollisionDetected(kermit,rw_platform3)|| isCollisionDetected(kermit,rw_platform4)|| isCollisionDetected(kermit,rw_platform5)|| isCollisionDetected(kermit,rw_platform6))
            hitleft= true;
        else
            hitleft= false;
    }
    ...
    public void hitwalltoright(){
        ...
        if(isCollisionDetected(kermit,wallright) || isCollisionDetected(kermit,lw_platform1)|| isCollisionDetected(kermit,lw_platform2)|| isCollisionDetected(kermit,lw_platform3)|| isCollisionDetected(kermit,lw_platform4)|| isCollisionDetected(kermit,lw_platform5) || isCollisionDetected(kermit,lw_platform6))
            hitright= true;
        else{
            hitright= false;
        }
    ...
    public void hitwallup(){
        ...
        if(isCollisionDetected(kermit,dw_platform1) || isCollisionDetected(kermit,dw_platform2) || isCollisionDetected(kermit,dw_platform3)  || isCollisionDetected(kermit,dw_platform4) || isCollisionDetected(kermit,dw_platform5)|| isCollisionDetected(kermit,dw_platform6)){
            maxheight = true;
        }
    }
    ...
    public void Ayyohedead(){
        if(score <10){
            ...
            AudioPlay.stopAudio();
            Intent i = new Intent(this, boss_fight.class);
            i.putExtra("score", score);
            startActivity(i);
        }
    }
